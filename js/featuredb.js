window.featuredb={
    ...
    "c2sc": {
        ...
        "state": "discretionary",
        "automatic": "true",
        "description": "Substitutes capital characters for small capitals. Small capitals are often used to set acronyms. Compare with [`smcp`](#smcp), which substitutes lowercase letters for small capitals.\n",
        "fea": "feature c2sc {\n  sub A by A.sc;\n  sub B by B.sc;\n  # ...\n} c2sc;\n",
        "example": {
            "font": "EB Garamond",
    ...
    "c2pc": {
        ...
        "state": "discretionary",
        "description": "Substitutes capital characters for petite capitals. See the [`pcap`](#pcap) feature for a description of petite capitals. See also [`c2sc`](#c2sc).\n",
        "fea": "feature c2pc {\n  sub A by A.pc;\n  sub B by B.pc;\n  # ...\n} c2pc;\n",
    ...
    "smcp": {
        ...
        "state": "discretionary",
        "automatic": "true",
        "description": "Substitutes lowercase characters for small capitals. Small capitals are often used to set acronyms. Compare with [`c2sc`](#c2sc), which substitutes uppercase letters for small capitals.\n\nNote that as this feature changes the case of the glyph, font engineers should ensure that any language-specific localisations are taken into account during case conversion - for example, when applying this feature to the letter `i` in Turkish, the returned form should appear with a dot above. (This is often achieved by replacing i with `idotless dotaccent` or similar in the [`locl`](#locl) feature.)\n",
        "fea": "feature smcp {\n  sub a by A.sc;\n  sub b by B.sc;\n  # ...\n} smcp;\n",
        "example": {
            "font": "EB Garamond",
            "text": "This"
